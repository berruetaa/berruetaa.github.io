    ...
    <div class="games-grid">
      <div class="game-item">
        <a href="{{ '/juegos/papas/scooperia' | relative_url }}">
          <img src="{{ '/assets/flash/papasscooperia/icon_300x300_papasscooperia.png' | relative_url }}" alt="Papa's Scooperia">
      ...
      <div class="game-item">
        <a href="{{ '/juegos/papas/tacomia' | relative_url }}">
          <img src="{{ '/assets/flash/papastacomia/icon_300x300_tacomia.png' | relative_url }}" alt="Papa's Taco Mia">
          <p>Papa's Taco Mia</p>
        </a>
      </div>
    </div>
